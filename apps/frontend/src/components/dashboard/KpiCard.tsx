...
export const KpiCard = memo(function KpiCard({ label, value, trend, icon: Icon, color = '#38bdf8', points, to }: { label: string; value: number | string; trend: string; icon: ComponentType<{ className?: string }>; color?: string; points: number[]; to: string }) {
