...
import { getGraphStats } from './neo4jGraphApi'
...
export const getAvailablePrivilegedTargets=async()=>{const stats=await getGraphStats();return stats.nodeCount>0?getPrivilegedTargets():[]}
